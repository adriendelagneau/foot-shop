...
const Video = () => {
    return (
        <div >
            <video autoPlay loop muted className="w-[100vw] h-screen object-cover relative ">
            ...
            <div className="flex justify-center items-center absolute flex-col w-100 bottom-40 left-6 text-7xl font-bold lg:text-8xl xl:text-9xl -z-1">
